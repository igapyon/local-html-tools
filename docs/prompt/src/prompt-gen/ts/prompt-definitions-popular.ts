const popularPromptDefinitions = [
  ...
  },
  {
    ...
    requiresCommitId: false,
    buildBody: () => appendMarkdownFenceInstruction(`アプリ/ソフトウェア修正担当者向けの不具合報告(バグ票)を起票します。修正担当の開発者がすぐ調査と再現に入れるように、対話しながら整理してください。まずは初回起票に必要な前半部分を優先して質問し、前半が埋まった段階でいったん Markdown 形式の不具合報告としてまとめてください。原因分析や対応方針まで進められるだけの情報がある場合に限って、後半部分も続けて埋めてください。質問は一度に詰め込みすぎず、調査に必要なものから優先して確認してください。
...
「起票時点に記入」は初回起票の時点で必ず整理してください。「フォローアップ」は、原因分析や対応方針まで進められるだけの情報がある場合に埋めてください。情報が不足している場合は、空欄のままにせず、不足している旨が分かるように各項目へ記載してください。原因や解決策がまだ確定していない場合は、断定せずに候補や見立てとして記載してください。`)
  },
  {
    ...
    requiresCommitId: false,
    buildBody: () => appendMarkdownFenceInstruction(`不具合管理向けの不具合報告(管理票)を起票します。管理担当者が優先度、担当、対応状況、意思決定ポイントをすぐ判断できるように、対話しながら整理してください。まずは初回起票に必要な項目を優先して質問し、「起票時点に記入」が埋まった段階でいったん Markdown 形式の管理票としてまとめてください。優先度判断や担当アサイン、対応方針まで進められるだけの情報がある場合に限って、「フォローアップ」も続けて埋めてください。質問は一度に詰め込みすぎず、管理判断に必要なものから優先して確認してください。
...
「起票時点に記入」は初回起票の時点で必ず整理してください。「フォローアップ」は、優先度判断、担当決定、対応方針まで進められるだけの情報がある場合に埋めてください。情報が不足している場合は、空欄のままにせず、不足している旨が分かるように各項目へ記載してください。優先度や担当がまだ確定していない場合は、断定せずに要判断や暫定値として記載してください。`)
  },
  {
    ...
    requiresCommitId: false,
    buildBody: () => appendMarkdownFenceInstruction(`品質分析向けの不具合報告(分析票)を起票します。品質分析担当者が発生傾向、影響傾向、原因の見立て、混入工程、検出工程、再発防止の観点を整理できるように、対話しながら整理してください。まずは初回起票に必要な項目を優先して質問し、「起票時点に記入」が埋まった段階でいったん Markdown 形式の分析票としてまとめてください。原因分析、工程分析、再発防止策まで進められるだけの情報がある場合に限って、「フォローアップ」も続けて埋めてください。質問は一度に詰め込みすぎず、傾向分析に必要なものから優先して確認してください。
...
「起票時点に記入」は初回起票の時点で必ず整理してください。「フォローアップ」は、原因分析、工程分析、再発防止策まで進められるだけの情報がある場合に埋めてください。情報が不足している場合は、空欄のままにせず、不足している旨が分かるように各項目へ記載してください。原因や工程分析がまだ確定していない場合は、断定せずに見立てや調査中の状態として記載してください。`)
  },
  {
    ...
    requiresCommitId: false,
    buildBody: () => appendMarkdownFenceInstruction(`顧客対応向けの不具合報告(案内票)を起票します。顧客対応担当者が、顧客や利用者に対して何が起きているか、誰にどの範囲で影響するか、回避策はあるか、次にいつ連絡すべきかを分かりやすく説明できるように、対話しながら整理してください。まずは初回案内に必要な項目を優先して質問し、「起票時点に記入」が埋まった段階でいったん Markdown 形式の案内票としてまとめてください。状況更新、回避策、恒久対応の見通しまで進められるだけの情報がある場合に限って、「フォローアップ」も続けて埋めてください。質問は一度に詰め込みすぎず、顧客説明に必要なものから優先して確認してください。
...
「起票時点に記入」は初回案内の時点で必ず整理してください。「フォローアップ」は、状況更新、回避策、恒久対応の見通しまで進められるだけの情報がある場合に埋めてください。情報が不足している場合は、空欄のままにせず、不足している旨が分かるように各項目へ記載してください。顧客向け説明では、未確定事項を断定せず、現時点の確認状況が分かる形で記載してください。`)
  },
  {
