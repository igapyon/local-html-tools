...
`
    },
    {
        ...
        buildBody: (_commitId, subject) => {
            ...
            return `Qiita 向けの技術記事を作文します。テーマ・メモをもとに、Qiita で読み慣れた読者が追いやすく、実務的で落ち着いた記事として読めることを重視して構成してください。
...
- 与えるテーマ、下書き、箇条書きメモをもとに、Qiita 投稿用の記事タイトルと記事本文を Markdown 形式で作文する
...
- 焦点がぼやける兆候がある場合は、まず「話題が広がりすぎているため分割したほうがよい可能性がある」と明示し、どの単位で記事を分けるとよいかを先に提案する
  ...
  - まず本記事では概要と判断理由に絞り、詳細は関連記事へ分ける案を提案します`;
    ...
    },
    {
        ...
        buildBody: (_commitId, subject) => {
            ...
            return `note 向けの記事を作文します。テーマ・メモをもとに、自然な読み物として読めて、体験の意味や気づきが伝わる記事になることを重視して構成してください。
...
- 与えるテーマ、下書き、箇条書きメモをもとに、note 投稿用の記事タイトルと記事本文を Markdown 形式で作文する
- 文体は日本語の「です・ます調」を基本にする
- 自然な読み物として書く
- 誇張した言い回しや煽る表現は避ける
