const popularPromptDefinitions = [
    ...
    },
    {
        ...
        label: "P912-001: 非技術者向けに要約",
        keywords: ["P912-001", "non-technical summary", "executive summary", "plain language", "for non engineers", "非技術者向け", "平易化", "やさしく要約", "一般向け", "ひぎじゅつしゃむけ", "へいいか"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P912-002: 非技術者向けに短く要約",
        keywords: ["P912-002", "short non-technical summary", "brief summary", "3 line summary", "plain brief", "短く要約", "短い要約", "三行要約", "非技術者向け要約", "みじかくようやく", "さんぎょうようやく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P925-001: 選択肢比較表を作成",
        keywords: ["P925-001", "comparison table", "option comparison", "tradeoff table", "decision table", "比較表", "選択肢比較", "比較一覧", "トレードオフ表", "ひかくひょう", "せんたくしひかく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P925-002: 選択肢のメリット・デメリット比較表を作成",
        keywords: ["P925-002", "pros cons table", "merit demerit", "pros and cons", "tradeoff comparison", "メリット", "デメリット", "比較表", "賛否", "めりっと", "でめりっと"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P913-001: 対象読者を変えて説明",
        keywords: ["P913-001", "change audience", "audience shift", "rewrite for audience", "different audience", "対象読者", "読者変更", "対象別説明", "読み手を変える", "たいしょうどくしゃ", "よみてをかえる"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P913-002: 複数の対象読者向けに書き分ける",
        keywords: ["P913-002", "multiple audiences", "rewrite for beginner and expert", "audience variants", "reader variants", "複数読者", "書き分け", "初学者向け", "管理者向け", "ふくすうどくしゃ", "かきわけ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P914-001: 要点だけを抽出",
        keywords: ["P914-001", "key points", "extract key points", "main points", "highlight points", "要点抽出", "要点だけ", "重要ポイント", "ハイライト", "ようてんちゅうしゅつ", "じゅうようぽいんと"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P914-002: 決定事項だけを抽出",
        keywords: ["P914-002", "decision extract", "decision summary", "decisions only", "agreed points", "決定事項抽出", "決定だけ", "合意事項", "けっていじこうちゅうしゅつ", "ごういじこう"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P924-001: JSON 形式で出力",
        keywords: ["P924-001", "json output", "structured json", "json format", "machine readable", "JSON出力", "構造化出力", "機械可読", "じぇいそんしゅつりょく", "こうぞうかしゅつりょく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P924-002: Markdown 表形式で出力",
        keywords: ["P924-002", "markdown table", "table output", "markdown format", "tabular output", "Markdown表", "表形式", "表出力", "まーくだうんひょう", "ひょうけいしき"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P926-001: 比較したうえで推奨案を選ぶ",
        keywords: ["P926-001", "recommendation", "recommended option", "choose one", "best option", "推奨案", "おすすめ案", "案を選ぶ", "すいしょうあん", "おすすめあん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P926-002: トレードオフを整理して推奨する",
        keywords: ["P926-002", "tradeoff recommendation", "tradeoff summary", "pros cons recommendation", "decision tradeoff", "トレードオフ", "トレードオフ整理", "比較推奨", "とれーどおふ", "ひかくすいしょう"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P927-001: アイデアを広く列挙",
        keywords: ["P927-001", "brainstorm", "idea list", "idea generation", "divergent thinking", "アイデア出し", "案出し", "発散", "ぶれいんすとーむ", "はっさん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P927-002: 代替案を複数提案",
        keywords: ["P927-002", "alternatives", "alternative proposal", "multiple options", "backup ideas", "代替案", "別案", "複数案", "だいたいあん", "べつあん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P928-001: 次の一手を3件に絞る",
        keywords: ["P928-001", "next steps", "top 3 next actions", "prioritized actions", "what next", "次の一手", "次アクション", "3件に絞る", "つぎのいって", "じあくしょん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P928-002: 実行順に並べる",
        keywords: ["P928-002", "execution order", "ordered plan", "prioritized sequence", "step order", "実行順", "順番に並べる", "優先順", "じっこうじゅん", "じゅんばんにならべる"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P915-001: 初学者向けに説明",
        keywords: ["P915-001", "for beginners", "beginner friendly", "explain simply", "entry level explanation", "初学者向け", "初心者向け", "やさしく説明", "しょがくしゃむけ", "しょしんしゃむけ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P915-002: 専門文を平易な言葉に言い換える",
        keywords: ["P915-002", "plain language", "simplify technical text", "rewrite simply", "jargon free", "平易化", "言い換え", "専門文", "へいいか", "いいかえ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P944-001: メール文面を作成",
        keywords: ["P944-001", "email draft", "mail writing", "email response", "business mail", "メール文面", "メール作成", "メール返信", "めーるぶんめん", "めーるさくせい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P944-002: 議事録ドラフトを作成",
        keywords: ["P944-002", "meeting minutes", "minutes draft", "meeting note", "agenda notes", "議事録", "議事録ドラフト", "会議メモ", "ぎじろく", "かいぎめも"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P903-001: 課題一覧を整理",
        keywords: ["P903-001", "issue list", "problem list", "issues summary", "issue inventory", "課題一覧", "問題一覧", "論点一覧", "かだいいちらん", "もんだいいちらん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P903-002: 依存課題を抽出",
        keywords: ["P903-002", "dependency issues", "dependency risk", "blocked by", "dependent issues", "依存課題", "依存リスク", "前提課題", "いぞんかだい", "ぜんていかだい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P937-001: 実装計画を作成",
        keywords: ["P937-001", "implementation plan", "execution plan", "build plan", "work plan", "実装計画", "作業計画", "実施計画", "じっそうけいかく", "さぎょうけいかく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P937-002: 調査計画を作成",
        keywords: ["P937-002", "investigation plan", "research plan", "discovery plan", "analysis plan", "調査計画", "調査手順", "確認計画", "ちょうさけいかく", "かくにんけいかく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P938-001: チェックリストを作成",
        keywords: ["P938-001", "checklist", "review checklist", "qa checklist", "verification list", "チェックリスト", "確認項目", "点検項目", "ちぇっくりすと", "かくにんこうもく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P938-002: 根拠の弱い箇所を抽出",
        keywords: ["P938-002", "weak evidence", "unsupported claims", "weak rationale", "evidence check", "根拠が弱い", "裏付け不足", "根拠抽出", "こんきょがよわい", "うらづけぶそく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P968-001: 用語集を作成",
        keywords: ["P968-001", "glossary", "term list", "terminology", "definitions", "用語集", "用語一覧", "定義集", "ようごしゅう", "ていぎしゅう"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P968-002: 命名候補を提案",
        keywords: ["P968-002", "naming candidates", "name ideas", "label candidates", "naming proposal", "命名候補", "名前候補", "ラベル候補", "めいめいこうほ", "なまえこうほ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P969-001: FAQ を作成",
        keywords: ["P969-001", "faq", "frequently asked questions", "q and a", "common questions", "FAQ", "よくある質問", "Q&A", "ふぁっく", "よくあるしつもん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P969-002: ナレッジ向けに整理",
        keywords: ["P969-002", "knowledge base", "knowledge article", "internal knowledge", "knowledge formatting", "ナレッジ化", "ナレッジ整理", "社内向け整理", "ないれっじか", "しゃないむけせいり"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P929-001: 反対意見を代弁",
        keywords: ["P929-001", "counterargument", "devils advocate", "opposing view", "critique", "反対意見", "逆張り", "反論", "はんたいいけん", "はんろん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P929-002: この案が失敗するとしたらを考える",
        keywords: ["P929-002", "failure scenario", "premortem", "how this fails", "failure analysis", "失敗するとしたら", "プリモータム", "失敗シナリオ", "しっぱいするとしたら", "しっぱいしなりお"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P929-003: この主張への反証を考える",
        keywords: ["P929-003", "counterevidence", "disprove claim", "counterproof", "opposing evidence", "反証", "反証を考える", "反対根拠", "はんしょう", "はんたいこんきょ"],
        requiresCommitId: false,
        buildBody: () => `与えられた主張や結論について、それに対する反証を考えてください。どの前提が崩れると主張が弱くなるか、どの事実や観点が反対材料になりうるかを整理してください。`
    },
    {
        id: "popular-objection-list-request",
        label: "P929-004: 想定される反対意見を列挙する",
        keywords: ["P929-004", "list objections", "anticipated objections", "possible objections", "counterarguments list", "反対意見列挙", "想定反対意見", "反論候補", "はんたいいけんれっきょ", "はんろんこうほ"],
        requiresCommitId: false,
        buildBody: () => `与えられた案や提案について、想定される反対意見を列挙してください。技術面、運用面、コスト面、関係者調整の面などから、相手が懸念しそうな点を広く整理してください。`
    },
    {
        id: "popular-pm-view-request",
        label: "P911-001: PM視点で見る",
        keywords: ["P911-001", "pm perspective", "product manager view", "product perspective", "business priority", "PM視点", "プロダクト視点", "優先順位視点", "ぴーえむしてん", "ぷろだくとしてん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P911-002: セキュリティ視点で見る",
        keywords: ["P911-002", "security perspective", "security review", "threat perspective", "security concerns", "セキュリティ視点", "脅威視点", "安全性観点", "せきゅりてぃしてん", "きょういしてん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P904-001: 出来事を時系列で整理",
        keywords: ["P904-001", "timeline", "chronological order", "event timeline", "time sequence", "時系列", "タイムライン", "出来事整理", "じけいれつ", "たいむらいん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P904-002: 決定の流れを時系列で整理",
        keywords: ["P904-002", "decision timeline", "decision history", "chronological decisions", "decision sequence", "決定の流れ", "判断履歴", "意思決定時系列", "けっていのながれ", "はんだんりれき"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P905-001: 原因と結果を分けて整理",
        keywords: ["P905-001", "cause effect", "causal analysis", "cause and result", "why what happened", "原因と結果", "因果整理", "原因分析", "げんいんとけっか", "いんがせいり"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P905-002: 根本原因候補を列挙",
        keywords: ["P905-002", "root cause", "root cause candidates", "underlying cause", "why analysis", "根本原因", "真因候補", "原因候補", "こんぽんげんいん", "しんいんこうほ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P930-001: 本当の問題設定を見直す",
        keywords: ["P930-001", "problem framing", "reframe problem", "true problem", "problem definition", "問題設定", "問い直し", "本当の問題", "もんだいせってい", "といなおし"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P930-002: 問いを再定義する",
        keywords: ["P930-002", "redefine question", "reframe question", "question redesign", "better question", "問いを再定義", "問いの言い換え", "再定義", "といをさいていぎ", "といのいいかえ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P931-001: Must / Should / Could に分ける",
        keywords: ["P931-001", "moscow", "must should could", "prioritization", "priority split", "Must Should Could", "優先分類", "モスコウ", "ゆうせんぶんるい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P931-002: 今やる / 後でやる / やらないに分ける",
        keywords: ["P931-002", "now later never", "do later", "not now", "prioritization buckets", "今やる", "後でやる", "やらない", "いまやる", "あとでやる"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P931-003: 優先順位を番号付きで並べる",
        keywords: ["P931-003", "priority ranking", "rank priorities", "ordered priorities", "priority order", "優先順位", "優先順", "順位づけ", "ゆうせんじゅんい", "じゅんいづけ"],
        requiresCommitId: false,
        buildBody: () => `与えられた候補やタスクについて、優先順位を番号付きで並べてください。なぜその順番になるのかが分かるように、各項目の優先理由も簡潔に添えてください。`
    },
    {
        id: "popular-priority-criteria-request",
        label: "P931-004: 優先順位づけの観点を整理する",
        keywords: ["P931-004", "priority criteria", "prioritization criteria", "ranking criteria", "how to prioritize", "優先順位観点", "優先判断基準", "優先基準", "ゆうせんじゅんいかんてん", "ゆうせんはんだんきじゅん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P955-001: 項目を分類する",
        keywords: ["P955-001", "categorize items", "classification", "group items", "sorting", "分類", "項目分類", "整理分類", "ぶんるい", "こうもくぶんるい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P955-002: 論点をクラスタリングする",
        keywords: ["P955-002", "cluster issues", "clustering", "group topics", "issue clustering", "クラスタリング", "論点クラスタ", "話題整理", "くらすたりんぐ", "ろんてんくらすた"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P939-001: 対象範囲を明確化する",
        keywords: ["P939-001", "scope definition", "define scope", "scope clarification", "scope boundary", "対象範囲", "スコープ定義", "範囲明確化", "たいしょうはんい", "すこーぷていぎ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P939-002: 今回やること / やらないことを分ける",
        keywords: ["P939-002", "in scope out of scope", "scope split", "do and do not", "boundary split", "やること", "やらないこと", "対象外", "やることやらないこと", "たいしょうがい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P939-003: スコープ境界を明確にする",
        keywords: ["P939-003", "scope boundary", "scope edges", "boundary clarification", "in out boundary", "スコープ境界", "境界明確化", "対象境界", "すこーぷきょうかい", "きょうかいめいかくか"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P939-004: スコープ肥大化のリスクを整理する",
        keywords: ["P939-004", "scope creep", "scope expansion risk", "scope creep risk", "boundary drift", "スコープ肥大化", "スコープクリープ", "範囲拡大リスク", "すこーぷひだいか", "はんいかくだいりすく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P959-001: ユーザーストーリーとして書き直す",
        keywords: ["P959-001", "user story", "rewrite as user story", "story format", "user perspective", "ユーザーストーリー", "利用者視点", "すとーりーけいしき", "りようしゃしてん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P959-002: ユースケースを列挙する",
        keywords: ["P959-002", "use cases", "use case list", "scenario list", "usage scenarios", "ユースケース", "利用シナリオ", "使い方列挙", "ゆーすけーす", "りようしなりお"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P940-001: 受け入れ条件を作成",
        keywords: ["P940-001", "acceptance criteria", "acceptance conditions", "done criteria", "completion criteria", "受け入れ条件", "確認条件", "受入条件", "うけいれじょうけん", "かくにんじょうけん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P940-002: 完了条件を定義する",
        keywords: ["P940-002", "definition of done", "done criteria", "completion definition", "done definition", "完了条件", "Doneの定義", "完了定義", "かんりょうじょうけん", "だんのていぎ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P941-001: テスト観点を列挙",
        keywords: ["P941-001", "test viewpoints", "test ideas", "test perspectives", "test checklist", "テスト観点", "試験観点", "確認観点", "てすとかんてん", "しけんかんてん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P941-002: 正常系 / 異常系 / 境界値で整理",
        keywords: ["P941-002", "normal abnormal boundary", "test buckets", "boundary values", "test categories", "正常系", "異常系", "境界値", "せいじょうけい", "いじょうけい", "きょうかいち"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P916-001: 冗長文を短く書き直す",
        keywords: ["P916-001", "shorten text", "concise rewrite", "reduce verbosity", "make concise", "冗長文", "短く書き直す", "簡潔化", "じょうちょうぶん", "かんけつか"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P916-002: 箇条書きに整形する",
        keywords: ["P916-002", "bullet list", "format as bullets", "list formatting", "bulleted summary", "箇条書き", "箇条書き化", "リスト化", "かじょうがき", "りすとか"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P917-001: 英訳する",
        keywords: ["P917-001", "translate to english", "english translation", "translate english", "en translation", "英訳", "英語にする", "えいやく", "えいごにする"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P917-002: 和訳する",
        keywords: ["P917-002", "translate to japanese", "japanese translation", "translate japanese", "jp translation", "和訳", "日本語にする", "わやく", "にほんごにする"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P945-001: Issue 文面に変換",
        keywords: ["P945-001", "issue draft", "issue text", "convert to issue", "issue writing", "Issue文面", "Issue化", "課題票文面", "いしゅーぶんめん", "いしゅーか"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P945-002: レビュー依頼文に変換",
        keywords: ["P945-002", "review request", "request review", "review draft", "ask for review", "レビュー依頼文", "レビュー依頼", "れびゅーいらいぶん", "れびゅーいらい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P946-001: 不足情報を埋める質問を作る",
        keywords: ["P946-001", "clarifying questions", "missing information questions", "questions to ask", "fill gaps", "不足情報", "確認質問", "ヒアリング質問", "ふそくじょうほう", "かくにんしつもん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P946-002: 仕様確認質問を列挙",
        keywords: ["P946-002", "spec questions", "spec clarification", "requirements questions", "questions for spec", "仕様確認質問", "仕様質問", "要件確認", "しようかくにんしつもん", "ようけんかくにん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P932-001: 評価基準を定義",
        keywords: ["P932-001", "evaluation criteria", "success criteria", "judgment criteria", "assessment criteria", "評価基準", "判断基準", "成功基準", "ひょうかきじゅん", "はんだんきじゅん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P932-002: 比較軸を作る",
        keywords: ["P932-002", "comparison axes", "comparison criteria", "evaluation axes", "decision axes", "比較軸", "評価軸", "比較基準", "ひかくじく", "ひょうかじく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P956-001: 再利用テンプレートへ変換",
        keywords: ["P956-001", "template conversion", "reusable template", "make template", "boilerplate", "再利用テンプレート", "テンプレート化", "ひな形化", "さいりようてんぷれーと", "てんぷれーとか"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P956-002: ひな形化する",
        keywords: ["P956-002", "boilerplate", "draft template", "skeleton format", "make skeleton", "ひな形", "ひな形化", "骨格化", "ひながた", "こっかくか"],
        requiresCommitId: false,
        buildBody: () => `与えられた内容を、ひな形として使える骨格へ整えてください。まだ具体値が埋まっていなくても、どの順で何を書くのかが分かるように、見出しや項目を整理してください。`
    },
    {
        id: "popular-mermaid-prep-request",
        label: "P957-001: Mermaid 前の整理を行う",
        keywords: ["P957-001", "mermaid prep", "diagram prep", "prepare mermaid", "diagram structure", "Mermaid前整理", "図示前整理", "Mermaid準備", "まーめいどまえせいり", "ずじまえせいり"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P957-002: DOT 前のノード整理を行う",
        keywords: ["P957-002", "dot prep", "graphviz prep", "node prep", "prepare dot", "DOT前整理", "ノード整理", "Graphviz準備", "どっとまえせいり", "のーどせいり"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P970-001: 想定質問を増やして FAQ 化する",
        keywords: ["P970-001", "faq expansion", "expand faq", "anticipated questions", "question expansion", "想定質問", "FAQ拡張", "想定問答", "そうていしつもん", "そうていもんどう"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P970-002: 誤解ポイントから Q&A を作る",
        keywords: ["P970-002", "misunderstanding qa", "qa from confusion", "common misunderstandings", "qa generation", "誤解ポイント", "Q&A作成", "誤解対策", "ごかいぽいんと", "きゅーあんどえーさくせい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P933-001: ADR 風に整理する",
        keywords: ["P933-001", "adr", "architecture decision record", "decision record", "adr style", "ADR", "意思決定記録", "判断記録", "えーでぃーあーる", "いしけっていきろく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P933-002: 採用 / 不採用理由を記録する",
        keywords: ["P933-002", "adopt reject record", "decision log", "accepted rejected", "why adopted", "採用理由", "不採用理由", "採否記録", "さいようりゆう", "ふさいようりゆう"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P906-001: 記述間の矛盾を探す",
        keywords: ["P906-001", "consistency check", "find contradictions", "inconsistency", "contradiction scan", "矛盾", "整合性確認", "不整合", "むじゅん", "せいごうせいかくにん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P906-002: 用語の揺れを検出する",
        keywords: ["P906-002", "term drift", "term inconsistency", "terminology drift", "vocabulary mismatch", "用語の揺れ", "用語不整合", "表記揺れ", "ようごのゆれ", "ひょうきゆれ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P918-001: もっと抽象化して説明する",
        keywords: ["P918-001", "abstract explanation", "higher level", "abstract summary", "generalize", "抽象化", "上位概念", "抽象説明", "ちゅうしょうか", "じょういがいねん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P918-002: もっと具体化して説明する",
        keywords: ["P918-002", "make concrete", "concrete explanation", "more specific", "add specifics", "具体化", "具体説明", "もっと具体的", "ぐたいか", "ぐたいせつめい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P919-001: 具体例を3つ出す",
        keywords: ["P919-001", "three examples", "give examples", "sample examples", "example generation", "具体例3つ", "具体例", "例を出す", "ぐたいれい", "れいをだす"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P919-002: 良い例 / 悪い例を出す",
        keywords: ["P919-002", "good bad examples", "good example bad example", "example contrast", "contrastive examples", "良い例", "悪い例", "対比例", "よいれい", "わるいれい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P920-001: 初稿を改善する",
        keywords: ["P920-001", "improve draft", "revise first draft", "draft improvement", "polish draft", "初稿改善", "改稿", "ドラフト改善", "しょこうかいぜん", "かいこう"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P920-002: 弱い点だけを改善する",
        keywords: ["P920-002", "fix weak points", "targeted revision", "improve weak areas", "focused rewrite", "弱い点改善", "部分改善", "ピンポイント改善", "よわいてんかいぜん", "ぶぶんかいぜん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P921-001: 読みにくい箇所を洗う",
        keywords: ["P921-001", "hard to read", "readability issues", "reading friction", "find unclear parts", "読みにくい", "可読性", "読みにくい箇所", "よみにくい", "かどくせい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P921-002: 見出し構造を整える",
        keywords: ["P921-002", "heading structure", "outline cleanup", "heading organization", "document structure", "見出し構造", "アウトライン整理", "構造整理", "みだしこうぞう", "あうとらいんせいり"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P947-001: 反対相手を説得する文面を作る",
        keywords: ["P947-001", "persuasion", "persuasive writing", "convince opponent", "stakeholder persuasion", "説得文面", "説得", "反対相手", "せっとくぶんめん", "せっとく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P947-002: 合意形成向けに整理する",
        keywords: ["P947-002", "consensus building", "alignment", "agreement support", "stakeholder alignment", "合意形成", "合意向け", "調整文面", "ごういけいせい", "ちょうせいぶんめん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P934-001: 実装コストを粗く見積もる",
        keywords: ["P934-001", "rough cost", "rough estimate", "implementation cost", "high medium low", "コスト見積", "粗見積", "実装コスト", "こすとみつもり", "あらみつもり"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P934-002: コスト要因を洗い出す",
        keywords: ["P934-002", "cost factors", "effort drivers", "cost drivers", "complexity factors", "コスト要因", "工数要因", "複雑性要因", "こすとよういん", "こうすうよういん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P960-001: 依存先一覧を作る",
        keywords: ["P960-001", "dependency inventory", "dependency list", "upstream dependencies", "dependency map", "依存先一覧", "依存一覧", "依存マップ", "いぞんさきいちらん", "いぞんいちらん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P960-002: 依存削減候補を出す",
        keywords: ["P960-002", "dependency reduction", "reduce dependencies", "dependency cleanup", "dependency simplification", "依存削減", "依存整理", "依存簡素化", "いぞんさくげん", "いぞんせいり"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P948-001: ステークホルダーを整理する",
        keywords: ["P948-001", "stakeholders", "stakeholder mapping", "affected parties", "interested parties", "ステークホルダー", "利害関係者", "関係者整理", "すてーくほるだー", "りがいかんけいしゃ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P948-002: 説明相手ごとの関心を整理する",
        keywords: ["P948-002", "audience concerns", "stakeholder concerns", "interest mapping", "different audience interests", "関心整理", "説明相手", "相手別関心", "かんしんせいり", "あいてべつかんしん"],
        requiresCommitId: false,
        buildBody: () => `与えられた内容について、説明相手ごとに関心を整理してください。どの相手が何を気にするのか、何を先に説明すると伝わりやすいのかが分かるようにまとめてください。`
    },
    {
        id: "popular-can-cannot-request",
        label: "P942-001: できること / できないことを分ける",
        keywords: ["P942-001", "can cannot", "capability limits", "what is possible", "limitations summary", "できること", "できないこと", "限界整理", "できることできないこと", "げんかいせいり"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P942-002: 制約込みで期待値を合わせる",
        keywords: ["P942-002", "expectation alignment", "set expectations", "align expectations", "manage expectations", "期待値調整", "期待合わせ", "制約込み", "きたいちちょうせい", "きたいあわせ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P943-001: 運用手順を整理する",
        keywords: ["P943-001", "operation procedure", "runbook", "operational steps", "maintenance procedure", "運用手順", "運用フロー", "ランブック", "うんようてじゅん", "らんぶっく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P943-002: 障害時対応フローを整理する",
        keywords: ["P943-002", "incident flow", "incident response", "failure handling flow", "troubleshooting flow", "障害時対応", "障害対応フロー", "トラブル対応", "しょうがいじたいおう", "とらぶるたいおう"],
        requiresCommitId: false,
        buildBody: () => `与えられた内容について、障害時の対応フローを整理してください。何を確認し、どの順で切り分け、どこで連絡し、どの状態で収束とみなすのかが分かるようにまとめてください。`
    },
    {
        id: "popular-metrics-request",
        label: "P964-001: 観測すべき指標候補を出す",
        keywords: ["P964-001", "metrics candidates", "observability metrics", "what to measure", "monitoring metrics", "指標候補", "観測指標", "メトリクス候補", "しひょうこうほ", "かんそくしひょう"],
        requiresCommitId: false,
        buildBody: () => `与えられた内容について、観測すべき指標候補を出してください。何を見れば状態の良し悪しや異常の兆候が分かるのか、運用や改善に役立つ観点で整理してください。`
    },
    {
        id: "popular-observability-request",
        label: "P964-002: ログ / メトリクス / アラート観点を整理する",
        keywords: ["P964-002", "logs metrics alerts", "observability", "monitoring viewpoints", "alerting", "ログ", "メトリクス", "アラート", "観測観点", "ろぐ", "めとりくす", "あらーと"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P965-001: 事象報告文面を作成する",
        keywords: ["P965-001", "incident report", "status report", "issue report", "event report", "事象報告", "障害報告", "報告文面", "じしょうほうこく", "しょうがいほうこく"],
        requiresCommitId: false,
        buildBody: () => `与えられた内容をもとに、事象報告文面を作成してください。何が起きたのか、いつからか、影響は何か、現在どうなっているのかが短時間で伝わるように整理してください。`
    },
    {
        id: "popular-impact-scope-request",
        label: "P965-002: 影響範囲を整理する",
        keywords: ["P965-002", "impact scope", "affected scope", "impact analysis", "impact area", "影響範囲", "影響分析", "影響先", "えいきょうはんい", "えいきょうぶんせき"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P966-001: 脅威モデリングの入口を整理する",
        keywords: ["P966-001", "threat modeling", "security threats", "threat model entry", "security analysis", "脅威モデリング", "脅威整理", "脅威分析入口", "きょういもでりんぐ", "きょういせいり"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P966-002: 攻撃面を洗い出す",
        keywords: ["P966-002", "attack surface", "security surface", "exposure points", "entry points", "攻撃面", "攻撃面洗い出し", "露出箇所", "こうげきめん", "ろしゅつかしょ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P961-001: エンティティを抽出する",
        keywords: ["P961-001", "entity extraction", "entities", "domain entities", "object extraction", "エンティティ", "エンティティ抽出", "対象抽出", "えんてぃてぃ", "たいしょうちゅうしゅつ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P961-002: 関係性を整理する",
        keywords: ["P961-002", "relationship modeling", "relationships", "entity relationships", "relation map", "関係性", "関係整理", "関連整理", "かんけいせい", "かんれんせいり"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P962-001: API の入出力定義を整理する",
        keywords: ["P962-001", "api io", "api input output", "api contract", "request response", "API入出力", "API定義", "リクエストレスポンス", "えーぴーあいにゅうしゅつりょく", "えーぴーあいていぎ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P962-002: API のエラーパターンを整理する",
        keywords: ["P962-002", "api errors", "error patterns", "api error cases", "failure responses", "APIエラー", "エラーパターン", "失敗応答", "えーぴーあいえらー", "えらーぱたーん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P963-001: 画面要素を列挙する",
        keywords: ["P963-001", "ui elements", "screen elements", "interface elements", "screen inventory", "画面要素", "UI要素", "画面部品", "がめんようそ", "ゆーあいようそ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P963-002: 操作フローを整理する",
        keywords: ["P963-002", "interaction flow", "operation flow", "user flow", "screen flow", "操作フロー", "ユーザーフロー", "画面遷移", "そうさふろー", "ゆーざーふろー"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P971-001: README 改善観点を整理する",
        keywords: ["P971-001", "readme improvement", "documentation improvement", "readme review", "doc quality", "README改善", "READMEレビュー", "文書改善", "りーどみーかいぜん", "ぶんしょかいぜん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P971-002: 文書構成を見直す",
        keywords: ["P971-002", "document structure review", "doc structure", "restructure document", "outline review", "文書構成", "構成見直し", "アウトライン見直し", "ぶんしょこうせい", "こうせいみなおし"],
        requiresCommitId: false,
        buildBody: () => `与えられた文書について、構成を見直してください。情報の順番、見出しの切り方、正本情報と補助情報の分離など、読み手が追いやすくなる構成案を示してください。`
    },
    {
        id: "popular-learning-order-request",
        label: "P972-001: 学習順序を作る",
        keywords: ["P972-001", "learning order", "study order", "learning path", "curriculum order", "学習順序", "学習パス", "勉強順序", "がくしゅうじゅんじょ", "がくしゅうぱす"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P972-002: 練習問題を作る",
        keywords: ["P972-002", "practice problems", "exercises", "quiz generation", "learning exercises", "練習問題", "演習問題", "クイズ生成", "れんしゅうもんだい", "えんしゅうもんだい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P949-001: 利用者向け告知文を作成",
        keywords: ["P949-001", "user announcement", "announcement text", "notice for users", "change notice", "利用者向け告知", "告知文", "アナウンス文", "りようしゃむけこくち", "こくちぶん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P949-002: メンテナンス告知文を作成",
        keywords: ["P949-002", "maintenance notice", "maintenance announcement", "scheduled maintenance", "downtime notice", "メンテナンス告知", "停止告知", "保守告知", "めんてなんすこくち", "ていしこくち"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P907-001: 未定義ケースを洗い出す",
        keywords: ["P907-001", "undefined cases", "missing cases", "unhandled cases", "spec gaps", "未定義ケース", "仕様の穴", "未定義", "みていぎけーす", "しようのあな"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P907-002: 例外時仕様の穴を補う質問を作る",
        keywords: ["P907-002", "exception spec questions", "edge case questions", "missing spec questions", "exception handling questions", "例外時仕様", "仕様穴質問", "境界ケース質問", "れいがいじしよう", "きょうかいけーすしつもん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P922-001: 誤解を招く表現を洗い出す",
        keywords: ["P922-001", "misleading expressions", "misleading wording", "ambiguous phrasing", "confusing text", "誤解を招く表現", "曖昧表現", "誤読しやすい", "ごかいをまねくひょうげん", "あいまいひょうげん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P922-002: 配慮不足リスクを確認する",
        keywords: ["P922-002", "consideration risk", "sensitivity check", "fairness check", "inclusive wording", "配慮不足", "配慮リスク", "表現配慮", "はいりょぶそく", "ひょうげんはいりょ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P950-001: 曖昧な依頼を明確化する",
        keywords: ["P950-001", "clarify request", "clarify vague request", "refine request", "request clarification", "依頼明確化", "曖昧な依頼", "依頼整理", "いらいめいかくか", "あいまいないらい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P950-002: 依頼内容を分解する",
        keywords: ["P950-002", "break down request", "request decomposition", "task breakdown from request", "split request", "依頼分解", "依頼内容分解", "タスク分解", "いらいぶんかい", "たすくぶんかい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P950-003: 曖昧な表現を具体化する",
        keywords: ["P950-003", "remove ambiguity", "clarify wording", "make specific", "reduce ambiguity", "曖昧さ除去", "曖昧表現具体化", "表現明確化", "あいまいさじょきょ", "ひょうげんめいかくか"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P950-004: 解釈が割れそうな語を洗い出す",
        keywords: ["P950-004", "ambiguous terms", "terms with multiple interpretations", "interpretation gaps", "vague words", "解釈が割れる語", "曖昧語", "解釈差", "かいしゃくがわれるご", "あいまいご"],
        requiresCommitId: false,
        buildBody: () => `与えられた内容について、解釈が割れそうな語や言い回しを洗い出してください。人によって意味がずれそうな語、範囲が曖昧な語、判断基準が不足している語を優先して整理してください。`
    },
    {
        id: "popular-agenda-request",
        label: "P951-001: 会議アジェンダ案を作る",
        keywords: ["P951-001", "meeting agenda", "agenda draft", "discussion agenda", "meeting topics", "会議アジェンダ", "アジェンダ案", "会議議題", "かいぎあじぇんだ", "ぎだいあん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P951-002: 会議後アクションを整理する",
        keywords: ["P951-002", "post meeting actions", "meeting follow-up", "action items", "after meeting", "会議後アクション", "宿題整理", "フォローアップ", "かいぎごあくしょん", "ふぉろーあっぷ"],
        requiresCommitId: false,
        buildBody: () => `与えられた会議内容や議事メモから、会議後アクションを整理してください。誰が何をするのか、どこが未決なのか、次回までの宿題は何かが分かるように整理してください。`
    },
    {
        id: "popular-slide-outline-request",
        label: "P952-001: スライド骨子を作る",
        keywords: ["P952-001", "slide outline", "presentation outline", "deck outline", "slide structure", "スライド骨子", "発表骨子", "資料骨子", "すらいどこっし", "はっぴょうこっし"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P952-002: 口頭説明の流れを作る",
        keywords: ["P952-002", "speaking flow", "talk track", "presentation flow", "oral explanation", "口頭説明", "説明の流れ", "トークトラック", "こうとうせつめい", "せつめいのながれ"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P958-001: 長文をスライド向けに再構成する",
        keywords: ["P958-001", "long text to slides", "slide conversion", "presentation rewrite", "deck conversion", "長文再構成", "スライド向け", "資料化", "ちょうぶんさいこうせい", "しりょうか"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P958-002: 会話ログを説明資料向けに再構成する",
        keywords: ["P958-002", "conversation log to material", "log restructuring", "explanatory material", "meeting log to deck", "会話ログ再構成", "説明資料化", "ログ資料化", "かいわろぐさいこうせい", "せつめいしりょうか"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P908-001: 依頼者の本当の目的を推定する",
        keywords: ["P908-001", "true intent", "infer intent", "underlying goal", "real objective", "本当の目的", "意図推定", "依頼者意図", "ほんとうのもくてき", "いとすいてい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P908-002: 表現されていない成功条件を推定する",
        keywords: ["P908-002", "hidden success criteria", "implicit success", "unstated goals", "success inference", "成功条件推定", "暗黙の成功条件", "隠れた要求", "せいこうじょうけんすいてい", "あんもくのせいこうじょうけん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P909-001: 結論を左右する前提を洗い出す",
        keywords: ["P909-001", "sensitive assumptions", "key assumptions", "critical assumptions", "what changes conclusion", "前提洗い出し", "重要前提", "結論を左右する前提", "じゅうようぜんてい", "けつろんをさゆうするぜんてい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P909-002: 重要パラメータの感度を整理する",
        keywords: ["P909-002", "parameter sensitivity", "sensitivity analysis", "key parameters", "sensitive factors", "感度分析", "重要パラメータ", "条件感度", "かんどぶんせき", "じゅうようぱらめーた"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P936-001: 旧版 / 新版の差分を整理する",
        keywords: ["P936-001", "version diff", "old vs new", "compare versions", "change summary", "旧版新版差分", "差分整理", "バージョン差分", "きゅうはんしんぱんさぶん", "ばーじょんさぶん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P936-002: 変更点の互換性影響を整理する",
        keywords: ["P936-002", "compatibility impact", "backward compatibility", "breaking changes", "compatibility analysis", "互換性影響", "破壊的変更", "互換性分析", "ごかんせいえいきょう", "はかいてきへんこう"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P953-001: ステークホルダー別の通知方針を整理する",
        keywords: ["P953-001", "stakeholder notification", "audience notification", "notification plan", "who to notify", "ステークホルダー通知", "通知方針", "通知先整理", "すてーくほるだーつうち", "つうちほうしん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P953-002: ステークホルダー別の通知文面を作る",
        keywords: ["P953-002", "stakeholder message", "notification message", "audience-specific notice", "notification wording", "通知文面", "相手別通知", "関係者向け連絡", "つうちぶんめん", "あいてべつつうち"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P935-001: KPI 候補を定義する",
        keywords: ["P935-001", "kpi definition", "success metrics", "kpi candidates", "evaluation metrics", "KPI", "評価指標", "成功指標", "けーぴーあい", "ひょうかしひょう"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P935-002: 評価指標の測り方を整理する",
        keywords: ["P935-002", "measure metrics", "metric measurement", "how to measure", "metric formula", "測り方整理", "指標測定", "評価方法", "はかりかたせいり", "しひょうそくてい"],
        requiresCommitId: false,
        buildBody: () => `与えられた評価指標について、どう測るのかを整理してください。必要なデータ、算出方法、集計単位、更新頻度、解釈上の注意点が分かるようにまとめてください。`
    },
    {
        id: "popular-claim-evidence-request",
        label: "P910-001: 主張と根拠を切り分ける",
        keywords: ["P910-001", "claim and evidence", "separate claims", "rationale mapping", "evidence structure", "主張と根拠", "根拠整理", "論拠整理", "しゅちょうとこんきょ", "ろんきょせいり"],
        requiresCommitId: false,
        buildBody: () => `与えられた内容について、主張と根拠を切り分けて整理してください。何を言っているのか、その裏付けは何か、推測に留まる部分はどこかが分かるように整理してください。`
    },
    {
        id: "popular-evidence-gap-request",
        label: "P910-002: 根拠不足の箇所を補強観点つきで整理する",
        keywords: ["P910-002", "evidence gaps", "missing evidence", "support gaps", "how to strengthen evidence", "根拠不足", "裏付け不足", "補強観点", "こんきょぶそく", "うらづけぶそく"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P910-003: 主張ごとに必要な根拠を列挙する",
        keywords: ["P910-003", "required evidence", "evidence needed", "support required", "what evidence is needed", "必要な根拠", "根拠要求", "主張別根拠", "ひつようなこんきょ", "こんきょようきゅう"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P910-004: 出典や裏付けが必要な箇所を示す",
        keywords: ["P910-004", "needs citation", "source needed", "citation required", "backing required", "出典が必要", "裏付け必要", "引用必要", "しゅってんがひつよう", "うらづけひつよう"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P923-001: エラーメッセージを改善する",
        keywords: ["P923-001", "improve error message", "better errors", "error wording", "user-friendly error", "エラーメッセージ改善", "エラー文面", "分かりやすいエラー", "えらーめっせーじかいぜん", "えらーぶんめん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P923-002: 利用者向けと開発者向けでエラー情報を分ける",
        keywords: ["P923-002", "user vs developer error", "split error info", "developer message", "error detail separation", "利用者向けエラー", "開発者向けエラー", "エラー情報分離", "りようしゃむけえらー", "かいはつしゃむけえらー"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P967-001: 観測設計を整理する",
        keywords: ["P967-001", "observability design", "monitoring design", "what to observe", "instrumentation design", "観測設計", "監視設計", "観測方針", "かんそくせっけい", "かんしせっけい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P967-002: 観測不足の箇所を洗い出す",
        keywords: ["P967-002", "observability gaps", "monitoring gaps", "missing instrumentation", "blind spots", "観測不足", "監視不足", "盲点洗い出し", "かんそくぶそく", "もうてんあらいだし"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P954-001: 次回再開用の要点を整理する",
        keywords: ["P954-001", "restart summary", "resume summary", "next session summary", "continue later", "再開支援", "再開用要点", "次回再開", "さいかいしえん", "じかいさいかい"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P954-002: 再開時に最初に確認すべき事項を列挙する",
        keywords: ["P954-002", "resume checklist", "restart checklist", "what to check first", "session restart", "再開チェック", "再開時確認", "再開手順", "さいかいちぇっく", "さいかいじかくにん"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P973-001: 図解化テキスト化",
        keywords: ["P973-001", "infographic text", "infographic copy", "visual summary text", "sketchnote text", "graphic recording text", "infographic", "インフォグラフィック", "グラレコ", "グラフィックレコーディング", "graphic recording", "visual summary", "sketchnote", "図解", "図解化", "可視化", "1枚図", "ホワイトボード風"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P973-002: 図解化描画指示",
        keywords: ["P973-002", "infographic drawing prompt", "visual prompt", "image prompt", "sketchnote prompt", "graphic recording prompt", "描画指示", "描画プロンプト", "画像生成プロンプト", "インフォグラフィック", "グラレコ", "グラフィックレコーディング", "graphic recording", "visual summary", "sketchnote", "図解", "図解化", "可視化", "1枚図", "ホワイトボード風"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P973-003: 図解化用の視覚要素を抽出",
        keywords: ["P973-003", "visual elements", "icon extraction", "visual motifs", "diagram elements", "視覚要素", "視覚要素抽出", "アイコン候補", "モチーフ抽出", "インフォグラフィック", "グラレコ", "graphic recording", "visual summary", "sketchnote", "図解", "図解化"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P973-004: 図解化のレイアウト案を作る",
        keywords: ["P973-004", "infographic layout", "layout plan", "visual layout", "diagram composition", "レイアウト案", "構図案", "配置案", "インフォグラフィック", "グラレコ", "graphic recording", "visual summary", "sketchnote", "図解", "図解化", "1枚図"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P974-001: 概念マップ化",
        keywords: ["P974-001", "concept map", "concept mapping", "knowledge map", "relationship map", "concept diagram", "概念マップ", "概念マップ化", "概念図", "概念関係図", "知識マップ", "関係図", "構造整理"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P975-001: タイムライン化",
        keywords: ["P975-001", "timeline", "timeline format", "chronological order", "event timeline", "mermaid timeline", "タイムライン化", "時系列化", "時系列整理", "じけいれつか", "たいむらいんか"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P976-001: フローチャート化",
        keywords: ["P976-001", "flowchart", "flow chart", "mermaid flowchart", "process flow", "decision flow", "フローチャート化", "手順図化", "分岐図", "ふろーちゃーとか", "てじゅんずか"],
        requiresCommitId: false,
    ...
    },
    {
        ...
        label: "P977-001: マインドマップ化",
        keywords: ["P977-001", "mindmap", "mind map", "mermaid mindmap", "topic expansion", "brainstorm map", "マインドマップ化", "論点展開", "放射状整理", "まいんどまっぷか", "ろんてんてんかい"],
        requiresCommitId: false,
