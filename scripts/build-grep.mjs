...
const TARGET = {
  id: "find-gen",
  baseDir: "docs/grep",
  srcHtml: "docs/grep/find-gen-src.html",
  outHtml: "docs/grep/find-gen.html",
  cssOrder: [
    "../../lht-cmn/css/components.css",
    "src/find-gen/css/app.css"
  ],
  jsOrder: [
    "../../lht-cmn/vendor/material-web-outlined-text-field.bundle.js",
    "../../lht-cmn/js/components.js",
    "src/find-gen/js/main.js"
  ]
};

buildTarget(TARGET);
console.log(`[build:grep] generated ${TARGET.outHtml}`);
