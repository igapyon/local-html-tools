...
const LOCAL_DATA_DIR = path.resolve(ROOT, "docs/xlsx2md/local-data");
const tokenizerCode = readFileSync(path.resolve(ROOT, "docs/xlsx2md/src/xlsx2md/js/formula/tokenizer.js"), "utf8");
const parserCode = readFileSync(path.resolve(ROOT, "docs/xlsx2md/src/xlsx2md/js/formula/parser.js"), "utf8");
const evaluatorCode = readFileSync(path.resolve(ROOT, "docs/xlsx2md/src/xlsx2md/js/formula/evaluator.js"), "utf8");
const coreCode = readFileSync(path.resolve(ROOT, "docs/xlsx2md/src/xlsx2md/js/core.js"), "utf8");
